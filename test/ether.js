...
const execute = async () => {
    ...
    const l2ERC720 = pos.child.erc20;
    ...
    const l2ERC720Token = posClient.erc20(l2ERC720);
    const mumbaiERC720Token = posClient.erc20(mumbaiERC720, true);

    const balance = await l2ERC720Token.getBalance(from);
    ...
    // const tx = await l2ERC720Token.withdrawStart(
    //   10,
    //   {
    //     // nonce: 1974,
    //     // gasPrice: '1000',
