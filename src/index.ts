...
import { BridgeClient, ExitUtil, ITransactionOption, RootChain, TYPE_AMOUNT, Web3SideChainClient } from "@ramestta/ramajs";
...
export class PlasmaClient extends BridgeClient<IPlasmaClientConfig> {
    ...
    erc20(tokenAddress: string, isParent?: boolean) {
        tokenAddress = tokenAddress == null && !isParent ?
            RAMA_TOKEN_ADDRESS_ON_RAMESTTA : tokenAddress;
